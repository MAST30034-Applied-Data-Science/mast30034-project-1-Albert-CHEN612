...
taxi_6am=gpd.read_file('yellow_time_seg.csv')
...
plot_state_to_ax('green_6to8', axarr[0][0],'YlOrBr')
axarr[0][0].set_title('6am to 8am')

plot_state_to_ax('green_9to16', axarr[0][1],'YlOrBr')
axarr[0][1].set_title('9am to 4pm')

plot_state_to_ax('green_17to19', axarr[1][0], 'YlOrBr')
axarr[1][0].set_title('5pm to 7pm')

plot_state_to_ax('green_20to5', axarr[1][1],'YlOrBr')
axarr[1][1].set_title('8pm to 5am')

plt.savefig("yellow_time_seg.png", bbox_inches='tight')
