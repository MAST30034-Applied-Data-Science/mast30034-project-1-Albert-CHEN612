...
taxi_zone['green_5pm']=taxi_6am['green_5pm']
taxi_zone['green_6am']=taxi_6am['green_6am']
...
tickets['green_5pm']=pandas.to_numeric(tickets['green_5pm'])
tickets['green_6am']=pandas.to_numeric(tickets['green_6am'])
...
f, axarr = plt.subplots(1, 2, figsize=(12, 7), subplot_kw={'projection': proj})

# plt.suptitle('Yellow taxi pick-up times in March 1 2016 in NYC', fontsize=16)
plt.subplots_adjust(top=0.95)

plot_state_to_ax('yellow_5pm', axarr[0],'YlOrBr')
axarr[0].set_title('5pm')

plot_state_to_ax('yellow_6am', axarr[1],'YlOrBr')
axarr[1].set_title('6am')

plt.savefig("yellow_5pm_6am.png", bbox_inches='tight')


f, axarr = plt.subplots(1, 2, figsize=(12, 7), subplot_kw={'projection': proj})

# plt.suptitle('Green taxi pick-up times in March 1 2016 in NYC', fontsize=16)
plt.subplots_adjust(top=0.95)

plot_state_to_ax('green_5pm', axarr[0], 'Greens')
axarr[0].set_title('5pm')

plot_state_to_ax('green_6am', axarr[1],'Greens')
axarr[1].set_title('6am')

plt.savefig("green_5pm_6am.png", bbox_inches='tight')
